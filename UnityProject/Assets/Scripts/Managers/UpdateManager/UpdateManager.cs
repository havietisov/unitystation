...
public class UpdateManager : MonoBehaviour
{
	...
	public void Clear()
	{
		Debug.Log("removed " + CleanupUtil.RidListOfSoonToBeDeadElements(updateActions, u => (MonoBehaviour)u.Target) + " messed up events in UpdateManager.updateActions");
		...
		Debug.Log("removed " + (CleanupUtil.RidListOfSoonToBeDeadElements(pooledTimedUpdates, u => (MonoBehaviour)u?.Action?.Target) + CleanupUtil.RidListOfDeadElements(pooledTimedUpdates, u => (MonoBehaviour)u?.Action?.Target)) + " messed up events in UpdateManager.pooledTimedUpdates");
	}
